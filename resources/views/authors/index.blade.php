                    ...
                    <div class='row justify-content-center'>
                        <div class='col-3'>
                            <form action='/api/authors/edit/{{ $author->id }}' method='GET'>                            
                                @csrf
                                <button type='submit' class="btn btn-primary" data-toggle='tooltip' data-placement='right' title='edit'>
                        ...
                        <div class='col-3'>                            
                            <form action="/api/authors/delete/{{ $author->id }}" method="POST">
                                @csrf
                                <button type='submit' class='btn btn-primary' data-toggle='tooltip' data-placement='right' title='delete'>
